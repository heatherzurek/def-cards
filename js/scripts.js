$(document).ready(function() {
  //This line is telling jQuery to look at the HTML(index.html) document
  //Then calling the .ready() method on the HTML(index.html) document
  //The ready() method is an built in method in jQuery which helps to load the whole page then execute the rest of the code
  $("#eventhandler").click(function() {
    //Here you are targeting the id="eventhandler" from index.html
